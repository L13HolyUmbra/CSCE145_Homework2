...
class CircleSquare extends JFrame {
	...
	public CircleSquare(int x, int y, boolean on )
	{
	...
	public static void main(String[] args) {
		 ...
		 */
		CircleSquare first = new CircleSquare(CircleDiameter + 150, CircleDiameter + 150, true); 
		System.out.println(drawFilled);
		//uncomment the line below and comment the line above to view the unfilled shape.  
		CircleSquare second = new CircleSquare(CircleDiameter + 150, CircleDiameter + 150, false); 
		System.out.println(drawFilled);
